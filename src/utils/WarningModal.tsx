...
function WarningModal() {
  ...
  return (
    <div
      className={`fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 w-screen h-screen bg-transparent backdrop-blur-lg ${
        isOpen ? "" : "hidden"
      }`}
    >
      <div
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 space-y-6">
              <p className="text-sm xl:text-base lg:text-base md:text-base leading-relaxed text-gray-500 dark:text-gray-400">
                ...
                Just wanted to give you a heads up that some people might share
                opinions or ideas that could be seen as offensive or hurtful.
                But hey, that&apos;s the world we live in, right? So, let&apos;s
                keep things chill and show each other some love. Remember, this
                chatroom isn&apos;t regulated, so you chat at your own risk
                (don&apos;t accept invitations from strangers). Peace out!
              </p>
            </div>
